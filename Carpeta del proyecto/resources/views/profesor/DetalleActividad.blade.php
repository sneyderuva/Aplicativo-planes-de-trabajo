...
@section('subcontenido')
    <div class="d-flex ">
        <div class="me-auto p-2">
            ...
            <h5><small class="text-muted"><?php $n_act=$_POST['nombre_actividad']; echo $n_act; ?> ● última modificación: {última modificación}</small></h5>
            <hr class="border border-primary opacity-75">
            <div class="d-flex">
                <div class="me-auto p-2">
                <h5><small class="text-dark font-weight-bold text-">100 puntos</small></h5>
                </div>
                <div class="p-2">
